...
const App = () => {
  ...
  */
  ...
  // Tester function
  // useEffect(() => {
  //   console.log('getem', nftCollectionData, cerror, isLoading, isFetching);
  // }, [nftCollectionData, cerror, isLoading, isFetching]);

  useEffect(() => {
    // Initialise the Moralis server
    Moralis.start({
 ...
 */
  // const fetchNFTCollection = async (connectedContract) => {
